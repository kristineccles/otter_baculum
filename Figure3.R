...
leveneTest(sqrt_df$Density~as.factor(sqrt_df$Age_coded), center=mean) #pass
...
leveneTest(sqrt_df$PeakLoad~as.factor(sqrt_df$Age_coded), center=mean) #pass
...
leveneTest(sqrt_df$WorktoFail~as.factor(sqrt_df$Age_coded), center=mean) #pass
...
leveneTest(sqrt_df$Stiffness~as.factor(sqrt_df$Age_coded), center=mean) #pass
